...
function BusinessProfileSection({ data, onChange }: Props) {
  ...
  return (
    <CollapsibleSection
      title="가게 기본 정보"
      description="가게의 기본 정보와 업무 시간을 설정합니다"
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Input
              ...
              placeholder="예: 예쁜 피부관리샵"
              helperText="여기에 입력한 이름이 앱 전체에 표시됩니다"
            />
            <Input
              label="사업자 이름"
        ...
        <div className="border-t border-neutral-200 pt-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-neutral-800">업무 시간</h3>
            <InfoTooltip content="요일별 업무 시간을 상세하게 설정하려면 각 요일의 체크박스를 클릭하세요." />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-xs mt-1">
                    {isHoliday ? '정기 휴무' : isClosed ? '휴무' : `${hours?.open || '09:00'}`}
                  </div>
                </div>
              )
            })}
        ...
        <div className="border-t border-neutral-200 pt-6">
          ...
          >
            <option value="7">1주일 전까지</option>
            <option value="14">2주일 전까지</option>
            <option value="28">4주일 전까지</option>
            <option value="56">8주일 전까지</option>
          </Select>
        </div>
      </div>
    </CollapsibleSection>
