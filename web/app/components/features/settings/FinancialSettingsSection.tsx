...
function FinancialSettingsSection({ data, onChange }: Props) {
  ...
  return (
    <CollapsibleSection
      title="재무 및 회계 설정"
      description="수입과 비용 카테고리를 관리합니다."
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-neutral-800">수입 카테고리 관리</h3>
            <InfoTooltip content="자주 발생하는 수입 카테고리를 등록하여 빠르게 선택할 수 있습니다." />
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <CreditCard className="w-5 h-5 text-neutral-700" />
            <h3 className="text-lg font-semibold text-neutral-800">지출 카테고리 관리</h3>
            <InfoTooltip content="자주 사용하는 지출 카테고리를 등록하여 빠르게 선택할 수 있습니다." />
          </div>
