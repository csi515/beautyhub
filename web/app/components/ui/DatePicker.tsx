            ...
            return (
              <Grid item xs={12 / 7} key={idx}>
                <IconButton
                  ...
                  size="small"
                  aria-label={`${year}년 ${month + 1}월 ${date.getDate()}일 선택`}
                  sx={{
                    width: '100%',
                    aspectRatio: '1/1',
                    ...
                    bgcolor: isSelected ? 'var(--primary-600)' : isToday ? 'var(--primary-50)' : 'transparent',
                    color: isSelected ? 'white' : isToday ? 'var(--primary-600)' : 'var(--neutral-700)',
                    transition: 'all 0.2s ease-out',
                    '&:hover': {
                      bgcolor: isSelected ? 'var(--primary-700)' : 'var(--primary-100)',
                      transform: 'scale(1.1)',
                    },
                    '&:focus-visible': {
                      outline: '2px solid var(--primary-500)',
